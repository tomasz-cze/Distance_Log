        ...
        return (
            <div className="popBackground">
                <div className="popUp">
                    ...
                    <input class="w3-input" type="text" id="pointA" onChange={event => this.changePosition (event)} placeholder="Punkt startowy" value={this.state.pointA}></input><br/>
                    <input type="text" id="pointB" onChange={event => this.changePosition (event)} placeholder="Punkt docelowy" value={this.state.pointB}></input><br/>
